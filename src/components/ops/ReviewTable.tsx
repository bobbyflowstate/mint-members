...
const reviewStatusLabels: Record<ReviewDecision, string> = {
  pending: "Pending review",
  approved: "Approved",
  denied: "Denied",
};

const reviewStatusBadgeClasses: Record<ReviewDecision, string> = {
    ...
    <div className="space-y-4">
      <div className="space-y-3 md:hidden">
        {applications.map((app) => {
          const decision = getReviewDecision(app.status);
          const isProcessing = processingId === app._id;
          const isApproveDisabled = isProcessing || decision === "approved";
          const isDenyDisabled = isProcessing || decision === "denied";
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <span
                  className={clsx(
                    ...
                    reviewStatusBadgeClasses[decision]
                  )}
                >
                  {reviewStatusLabels[decision]}
                </span>
              </div>
