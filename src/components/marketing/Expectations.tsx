...
export function Expectations({ content, showHeader = true }: ExpectationsProps) {
  return (
    <section id="expectations" className={showHeader ? "py-16 sm:py-24" : "py-8"}>
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className={`mx-auto max-w-2xl ${showHeader ? "mt-16 sm:mt-20 lg:mt-24" : ""} lg:max-w-none`}>
