 ...
 */
export function ApplicationFormWithCheck({
  content,
  paymentsEnabled,
}: {
  ...
  if (!existingApplication && capacity.isFull) {
    return (
      <div className="text-center py-8">
        ...
        <p className="mt-2 text-slate-400 max-w-sm mx-auto">
          All {capacity.maxMembers} spots have been reserved. We are no longer accepting reservations.
        </p>
    ...
    if (existingApplication.cancelled) {
      return (
        <div className="text-center py-8">
          ...
          <p className="mt-2 text-slate-400 max-w-sm mx-auto">
            This application is no longer active. Please contact ops if you believe this is an error.
          </p>
        </div>
      );
    }
